...
namespace Game
{
  partial class SelectClassForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.panel1.Location = new System.Drawing.Point(421, 78);
      ...
      this.panel2.Size = new System.Drawing.Size(342, 339);
      ...
      this.label4.Text = "Перезарядка: 20";
      // 
      // label5
      // 
      ...
      this.label5.Text = "Область атаки: 10";
      // 
      // label6
      // 
      ...
      this.label6.Text = "Область атаки: 5";
      // 
      // label7
      // 
      ...
      this.label7.Text = "Перезарядка: 10";
      // 
      // label8
      // 
